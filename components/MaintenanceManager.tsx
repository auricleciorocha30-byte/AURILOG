  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      {isModalOpen && createPortal(
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md flex items-end md:items-center justify-center p-0 md:p-4 z-[100] overflow-y-auto">
          <div className="bg-white w-full md:max-w-md rounded-t-[2.5rem] md:rounded-[2.5rem] p-8 shadow-2xl animate-slide-up my-0 md:my-8 max-h-[90vh] h-auto md:h-auto md:max-h-[90vh] overflow-y-auto">
